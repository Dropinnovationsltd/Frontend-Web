        ...
        <table className="w-full min-w-[800px] border-collapse border-spacing-0">
          ...
          <thead className="bg-[#ede9e9]">
            <tr>
              ...
              <th className="p-[16px] text-left text-[12px] font-[1000] text-[#808080] uppercase tracking-wider">Title</th>            
              <th className="p-[16px] text-left text-[12px] font-[1000] text-[#808080] uppercase tracking-wider">CMS type</th>
              <th className="p-[16px] text-left text-[12px] font-[1000] text-[#808080] uppercase tracking-wider">description</th>
