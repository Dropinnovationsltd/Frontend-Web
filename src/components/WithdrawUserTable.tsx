...
const generateMockUsers = (count: number): User[] => {
  ...
  return (
    <div className="container mx-auto px-[16px] py-[20px]">
        ...
        <table className="w-full min-w-[800px] border-collapse border-spacing-0">
          ...
          <thead className="bg-[#ede9e9]">
            <tr>
              ...
              <th className="p-[16px] text-left text-[12px] font-[1000] text-[#808080] uppercase tracking-wider">Driver name</th>            
              <th className="p-[16px] text-left text-[12px] font-[1000] text-[#808080] uppercase tracking-wider">Driver phone</th>
              <th className="p-[16px] text-left text-[12px] font-[1000] text-[#808080] uppercase tracking-wider">Amount</th>
              <th className="p-[16px] text-left text-[12px] font-[1000] text-[#808080] uppercase tracking-wider">Request date</th>
...
export default WithdrawUserTable;