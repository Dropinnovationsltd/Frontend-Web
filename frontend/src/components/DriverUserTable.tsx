        ...
        <table className="w-full min-w-[800px] border-collapse border-spacing-0">
          ...
          <thead className="bg-[#ede9e9]">
            <tr>
              ...
              <th className="p-[16px] text-left text-[12px] font-[1000] text-[#808080] uppercase tracking-wider">Phone No.</th>
              <th className="p-[16px] text-left text-[12px] font-[1000] text-[#808080] uppercase tracking-wider">Image</th>
...
export default DriverUserTable;