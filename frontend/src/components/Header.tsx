  ...
  return (
    <div className='w-full relative'>
      ...
      {isDropdownOpen && (
        <div
         ref={dropdownRef}
         className="absolute z-10 w-fit right-0 bg-[#fff] rounded-[8px] shadow mt-[50px] overflow-hidden">
          <Link
            to="/settings" 
            className="block py-1 px-5 md:py-2 no-underline text-[#1f1f1f] hover:bg-[#96842c] hover:text-[#fff] transition duration-200"
          >
            <div className='flex flex-row'>
           
            <p className='no-underline text-[18px] md:px-4 px-[4px] text-[#808080] hover:text-[#fff]'>           
              Settings
            </p>
            </div>
          </Link>
          <Link
            to="/" 
            className="block no-underline px-5 md:py-2 text-[#1f1f1f] hover:bg-[#96842c] transition duration-200"
          >
